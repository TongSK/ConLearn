...
Run:
  python src/export_detector.py --csv data/dataset.csv --held-out safeguard --model-dir results/safeguard --output artifacts/detector_artifact.pt
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", default="artifacts/detector_artifact.pt")
